/**
 * Daily AI Coach v1 Tests
 */

import { describe, it, expect, beforeEach } from "vitest";
import { DailyCoachEngineV1, type LearnerProfile } from "../index";

describe("DailyCoachEngineV1", () => {
  let engine: DailyCoachEngineV1;

  beforeEach(() => {
    engine = new DailyCoachEngineV1();
  });
